...
const navLinks = [
  { href: "/repair", label: "Pendings" },
  { href: "/repair/call-to-customer", label: "Repaired " },
  { href: "/repair/completed-repairs", label: "Completed Repairs" },
  { href: "/repair/unrepairable-repairs", label: "Unrepairables" },
...
function RepairNav() {
  ...
  return (
    <div className={`${shouldHide ? "hidden" : ""} w-full`}>
      <nav className="w-[90%] max-w-6xl mx-auto my-2 bg-white border border-gray-200 rounded-full shadow-sm  py-2">
